...
const Experience = () => {
  return (
    <section
      id="experiences"
      className="py-5 px-[12vw] md:px-[7vw] lg:px-[16vw] font-sans bg-skills-gradient"
    >
      {/* Section Title */}
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold bg-linear-to-r from-purple-400 to-pink-600 bg-clip-text text-transparent mb-4 text-center mt-4">Experience</h2>
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex flex-col justify-between">
                  <div>
                    ...
                    <h4 className="text-lg sm:text-sm text-[var(--color-text-muted)]">
                      {experience.company}
                    </h4>
                  </div>
                  {/* Date at the bottom */}
                  <p className="text-sm text-[var(--color-text-soft)] mt-2">{experience.date}</p>
                </div>
              </div>

              <p className="mt-4 text-[var(--color-text-soft)] text-justify">{experience.desc}</p>
              <div className="mt-4">
                <h5 className="font-medium text-[var(--color-text)]">Skills:</h5>
